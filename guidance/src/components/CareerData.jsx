  ...
  return (
    ...
    <div className="pl-40 pr-40">
      ...
      <div className="mb-6">
        ...
        <input className="w-full px-4 py-3 leading-tight text-gray-500 placeholder-gray-500 border border-gray-200 rounded-lg shadow-xs focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="number" name="field-name" placeholder="Enter Amount" value={amount} onChange={(e) => setAmount(e.target.valueAsNumber)}/>
      </div>
      
      <div className="mb-6">
        <label className="block mb-2 font-medium text-gray-800" for="">Loan Term</label>
        <input className="w-full px-4 py-3 leading-tight text-gray-500 placeholder-gray-500 border border-gray-200 rounded-lg shadow-xs focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50" type="number" name="field-name" placeholder="Enter Amount" value={term} onChange={(e) => setTerm(e.target.valueAsNumber)}/>
      </div>
