...
function NavBarTwo() {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="hidden xl:block xl:w-1/3">
            <ul className="flex justify-center">
              ...
              <Link to="/explore">
                <li className="mr-12">
                  <a
                    className="font-medium text-gray-500 hover:text-green-500"
                    href="#"
                    // contentEditable="false"
                  >
                    Browse Careers
              ...
              <li>
                <a
                  className="font-medium text-grey-500 hover:text-coolGray-900"
                  href="#"
                  // contentEditable="false"
                ></a>
              </li>
          ...
          <div className="hidden xl:block xl:w-1/3">
            <div className="flex items-center justify-end">
              <Link to="/editprofile">
                <a
                  className="inline-block px-4 py-2 mr-2 font-medium leading-5 text-gray-500 bg-transparent rounded-md hover:text-green-500"
                  // contentEditable="false"
                >
                  Edit Profile
                </a>
      ...
      <div
        className={
          // `fixed top-0 left-0 z-50 hidden w-full h-full bg-opacity-50 navbar-menu bg-coolGray-900`
          `fixed top-0 left-0 z-50 ${
            isMenuOpen ? "block" : "hidden"
          } w-full h-1/2 bg-opacity-50 navbar-menu bg-coolGray-900`
        }
      >
        <div className="fixed top-0 bottom-0 left-0 w-4/6 max-w-xs bg-white">
            ...
            <div className="flex flex-col justify-between h-full">
              ...
              <ul className="py-6">
                <Link to="/explore">
                  <li>
                    <a
                      className="block px-4 py-3 font-medium rounded-md text-coolGray-500 hover:text-coolGray-900 hover:bg-coolGray-50"
                      href="#"
                    >
                      Browse Careers
                    </a>
              ...
              <div className="flex flex-wrap">
                {/* keep this for the not logged in Navbar, change "log out" to "sign up" */}
          ...
          <a
            className="absolute p-4 navbar-close top-5 right-3"
            href="#"
            onClick={toggleMenu}
          >
            <svg
