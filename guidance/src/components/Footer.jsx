...
function Footer() {
  return (
    <section className="overflow-hidden bg-coolGray-900" style={{backgroundImage: "url('./pattern-dark.svg')", backgroundPosition: "center"}}>
    <div className="container px-4 mx-auto">
      <div className="flex flex-wrap pt-24 pb-12 -mx-4 lg:items-center">
        <div className="w-full px-4 md:w-1/4 lg:w-auto">
        ...
        <div className="w-full px-4 md:w-3/4 lg:flex-1">
          <div className="flex flex-wrap justify-end -mx-3 lg:-mx-6">
            <div className="w-full p-3 md:w-auto md:py-0 md:px-6"><a className="inline-block text-lg font-medium md:text-xl text-coolGray-400 hover:text-coolGray-500" href="#">FAQs</a></div>
            <div className="w-full p-3 md:w-auto md:py-0 md:px-6"><a className="inline-block text-lg font-medium md:text-xl text-coolGray-400 hover:text-coolGray-500" href="#">About</a></div>
            <div className="w-full p-3 md:w-auto md:py-0 md:px-6"><a className="inline-block text-lg font-medium md:text-xl text-coolGray-400 hover:text-coolGray-500" href="#">Contact</a></div>
      
            <div className="w-full p-3 md:w-auto md:py-0 md:px-6"><a className="inline-block text-lg font-medium md:text-xl text-coolGray-400 hover:text-coolGray-500" href="#">Privacy</a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="container px-4 mx-auto">
      <div className="flex flex-wrap items-center py-12 md:pb-32">
        <div className="w-full mb-6 md:w-1/2 md:mb-0">
          <p className="font-medium text-coolGray-400">© 2023 Guidance. All rights reserved.</p>
        </div>
        <div className="w-full md:w-1/2">
          <div className="flex flex-wrap -mx-5 md:justify-end">
            <div className="px-5">
              <a className="inline-block text-coolGray-300 hover:text-coolGray-400" href="https://www.facebook.com/"target="_blank">
            ...
            <div className="px-5">
              <a className="inline-block text-coolGray-300 hover:text-coolGray-400" href="https://www.twitter.com/"target="_blank">
            ...
            <div className="px-5">
              <a className="inline-block text-coolGray-300 hover:text-coolGray-400" href="https://www.instagram.com/"target="_blank">
            ...
            <div className="px-5">
              <a className="inline-block text-coolGray-300 hover:text-coolGray-400" href="https://github.com/ " target="_blank">
            ...
            <div className="px-5">
              <a className="inline-block text-coolGray-300 hover:text-coolGray-400" href="https://www.linkedin.com/" target="_blank">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
