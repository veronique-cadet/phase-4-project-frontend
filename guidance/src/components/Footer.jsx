...
function Footer() {
  return (
    <section className="bg-coolGray-900 overflow-hidden" style={{backgroundImage: "url('./pattern-dark.svg')", backgroundPosition: "center"}}>
      ...
      <div className="flex flex-wrap lg:items-center pt-24 pb-12 -mx-4">
        ...
        <div className="w-full md:w-3/4 lg:flex-1 px-4">
          <div className="flex flex-wrap justify-end -mx-3 lg:-mx-6">
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Product</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Features</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Pricing</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Resources</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Careers</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Help</a></div>
            <div className="w-full md:w-auto p-3 md:py-0 md:px-6"><a className="inline-block text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium" href="#">Privacy</a></div>
          </div>
        </div>
      </div>
    </div>
