      ...
      <section className="bg-gray-50">
        <div className="px-4">
          <div className="content-center pt-6 pt-20 overflow-hidden bg-white border border-gray-100 rounded-md shadow-dashboard">
            <h2 className="pb-10 mb-4 text-4xl font-bold tracking-tighter text-center md:text-5xl text-coolGray-900">
              Your Paths&nbsp;
            </h2>
            <div className="">
              <table className="w-full">
                <tbody>
                  <tr className="bg-gray-500 whitespace-nowrap h-11 bg-opacity-80">
                    ...
                    <th className="text-lg font-medium text-center text-white uppercase whitespace-nowrap md:text-xl -500">
                      ESTMITATED TOTAL COST OF EDUCATION
                    </th>
                    <th className="text-lg font-medium text-center text-white uppercase whitespace-nowrap md:text-xl -500 ">
                      BREAK EVEN
                    </th>
