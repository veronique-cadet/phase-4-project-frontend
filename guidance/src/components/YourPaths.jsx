...
const pathCard = yourPaths.map((path) => {return <YourPathsCard path= {path} key= {path.id} />})
  ...
  return (
    <div>
      <NavBarTwo />
      <section className="bg-gray-50"><div className="px-4">
  <div className="content-center pt-6 pt-20 overflow-hidden bg-white border border-gray-100 rounded-md shadow-dashboard">
    <h2 className="pb-10 mb-4 text-4xl font-bold tracking-tighter text-center md:text-5xl text-coolGray-900">Your Paths&nbsp;</h2>
    <div className="">
      <table className="w-full"><tbody><tr className="bg-gray-500 whitespace-nowrap h-11 bg-opacity-80"><th className="pl-5 text-lg font-medium text-left text-white uppercase whitespace-nowrap md:text-xl -500 ">
        <p>CAREER&nbsp;</p>
        </th>
        ...
        <th className="text-lg font-medium text-center text-white uppercase whitespace-nowrap md:text-xl -500">ESTMITATED TOTAL COST OF EDUCATION</th>
        ...
        <div className="flex items-center -m-2">
          ...
          <div className="w-auto p-2">
            <p className="text-lg text-gray-800 md:text-xl">Coding course</p>
          </div>
        </div>
        </th>
        <th className="px-4 text-lg text-center text-green-500 whitespace-nowrap md:text-xl">$12,450.00</th>
        <th className="px-4 text-lg text-center text-gray-800 whitespace-nowrap md:text-xl">14,652</th>
