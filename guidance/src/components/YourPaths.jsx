    ...
    <div className="">
      <table className="w-full"><tbody><tr className="whitespace-nowrap h-11 bg-gray-50 bg-opacity-80"><th className="whitespace-nowrap text-lg md:text-xl  text-gray-500 font-medium uppercase text-left pl-5 pb-10">
        ...
        <div className="flex items-center -m-2">
          ...
          <div className="w-auto p-2">
            <p className="text-lg md:text-xl text-gray-800">Coding course</p>
          </div>
        </div>
        </th>
        <th className="whitespace-nowrap px-4 text-lg md:text-xl text-green-500 text-center">$12,450.00</th>
        <th className="whitespace-nowrap px-4 text-lg md:text-xl text-gray-800 text-center">14,652</th>
